...
public partial class WaterBornPaints : ContentPage
{
    ...
    public WaterBornPaints()
	{
        ...
        AddToGrid(column: 0, row: 0, image: "Images/CategoriesImages/water_paints.jpg", text: "Для сухих помещений", page: new PaintListScreen());
        AddToGrid(column: 0, row: 1, image: "Images/CategoriesImages/exterier_paint.jpg", text: "Для влажных помещений", page: new PaintListScreen());
